...
class NoDrakorIDPlugin : Plugin() {
    override fun load() {
        ...
        registerExtractorAPI(NoDrakorIDBoosterx())
        registerExtractorAPI(NoDrakorIDChillx())
        registerExtractorAPI(NoDrakorIDJavVids())
        registerExtractorAPI(NoDrakorIDUpload18())
